...
WebUI.waitForElementPresent(findTestObject('Landing Page/a_Daftar'), 0)

WebUI.click(findTestObject('Landing Page/a_Daftar'))
...
WebUI.verifyElementPresent(findTestObject('Login/h1_Selamat Datang'), 0)
