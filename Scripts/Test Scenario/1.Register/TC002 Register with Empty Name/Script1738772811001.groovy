...
WebUI.setText(findTestObject('Register/input_nama_lengkap_reg'), '')
...
WebUI.verifyElementPresent(findTestObject('Register/div_Harap isi nama lengkap anda'), 0)

WebUI.verifyElementText(findTestObject('Register/div_Harap isi nama lengkap anda'), 'Harap isi nama lengkap anda.')
