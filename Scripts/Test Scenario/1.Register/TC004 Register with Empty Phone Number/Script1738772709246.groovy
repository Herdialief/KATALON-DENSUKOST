...
WebUI.setText(findTestObject('Register/input_nomor_reg'), '')
...
WebUI.verifyElementPresent(findTestObject('Register/div_Harap isi nomor telepon anda'), 0)

WebUI.verifyElementText(findTestObject('Register/div_Harap isi nomor telepon anda'), 'Harap isi nomor telepon anda.')
