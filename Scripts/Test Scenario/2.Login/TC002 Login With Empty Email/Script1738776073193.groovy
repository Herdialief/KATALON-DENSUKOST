...
WebUI.verifyElementPresent(findTestObject('Login/div_Harap isi alamat email anda'), 0)

WebUI.verifyElementText(findTestObject('Login/div_Harap isi alamat email anda'), 'Harap isi alamat email anda.')
